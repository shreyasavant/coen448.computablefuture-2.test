...
public class AsyncProcessorTest {
    ...
    void failFast_allSucceed() throws Exception {
        ...
        String result = processor.processAsyncFailFast(services, List.of("msg1", "msg2")).get(1, TimeUnit.SECONDS);
    ...
    void failSoft_fallbackAppears() throws Exception {
        ...
        List<String> results = processor.processAsyncFailSoft(services, "msg", fallback).get(1, TimeUnit.SECONDS);
